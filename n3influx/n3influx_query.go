...
// ObjsBySP : (return objects, versions, IsFound)
func (n3ic *DBClient) ObjsBySP(tuple *pb.SPOTuple, ctx string, extSub, extPred bool, vLow, vHigh int64) (subs, preds, objs []string, vers []int64, found bool) {
...
func (n3ic *DBClient) QueryTuplesBySP(tuple *pb.SPOTuple, ctx string, ts *[]*pb.SPOTuple, vLow, vHigh int64) {
	...
	if subs, preds, objs, vers, ok := n3ic.ObjsBySP(tuple, ctx, false, true, vLow, vHigh); ok {
		for i := range subs {
...
func (n3ic *DBClient) LastObjVer(tuple *pb.SPOTuple, ctx string) (string, int64) {
	if _, _, objs, vers, found := n3ic.ObjsBySP(tuple, ctx, false, false, 0, 0); found {
