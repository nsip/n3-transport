...
func (*SPOTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_tuple_1150fdf19cc86291, []int{0}
}
...
func init() { proto.RegisterFile("tuple.proto", fileDescriptor_tuple_1150fdf19cc86291) }

var fileDescriptor_tuple_1150fdf19cc86291 = []byte{
